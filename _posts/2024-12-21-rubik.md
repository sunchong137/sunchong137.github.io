---
title: 'Non-academic: Rubik's Cube Top Layer'
date: 2024-12-21
...
I will provide some useful formulae for recovering the top layer of rubik's cube. Here I will use
...
2. Each operation is a 90 degree rotation. A plain upper-cased letter means clockwise rotation, and a letter with a prime, e.g. R', means counter clockwise rotation. The rotation operations are:
    - R/R' (right), L/L' (left), F/F' (front), U/U' (upper), D/D' (lower), B/B' (back).
...
<figure>
  <img
  src="../../images/posts/rubik/rubik1.png"
  alt="Overview"
  style="width:30%">
 <img
